package com.example.TestNFD3_sensordatastoragebuffered;
...
public class TestNFD3_sensordatastoragebuffered extends AppCompatActivity implements SensorEventListener, OnFragmentInteractionListener {
    ...
    private TestNFD3_sensordatastoragebuffered thisClass;
    private final Thread BgThread = new Thread() {
    @Override
    public void run() {
            String argv[] = new String[] {"MainActivity","TestNFD3_sensordatastoragebuffered"};
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.e("TestNFD3_sensordatastoragebuffered.updateTextViewById", ex.getLocalizedMessage());
                }
            }
        });
    }
    private native int naMain(String[] argv, TestNFD3_sensordatastoragebuffered pThis);
    private native void naOnAppStateChange(int state);
    static {
        System.loadLibrary("TestNFD3_sensordatastoragebuffered");
    }
