package com.example.TestNFD3_sensordatastorage;
...
public class TestNFD3_sensordatastorage extends AppCompatActivity implements SensorEventListener, OnFragmentInteractionListener {
    ...
    private TestNFD3_sensordatastorage thisClass;
    private final Thread BgThread = new Thread() {
    @Override
    public void run() {
            String argv[] = new String[] {"MainActivity","TestNFD3_sensordatastorage"};
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.e("TestNFD3_sensordatastorage.updateTextViewById", ex.getLocalizedMessage());
                }
            }
        });
    }
    private native int naMain(String[] argv, TestNFD3_sensordatastorage pThis);
    private native void naOnAppStateChange(int state);
    static {
        System.loadLibrary("TestNFD3_sensordatastorage");
    }
