...
public class TestNFD extends AppCompatActivity implements SensorEventListener, OnFragmentInteractionListener {
    ...
    private TestNFD thisClass;
    private final Thread BgThread = new Thread() {
    @Override
    public void run() {
            String argv[] = new String[] {"MainActivity","TestNFD"};
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.e("TestNFD.updateTextViewById", ex.getLocalizedMessage());
                }
            }
        });
    }
    private native int naMain(String[] argv, TestNFD pThis);
    private native void naOnAppStateChange(int state);
    static {
        System.loadLibrary("TestNFD");
    }
